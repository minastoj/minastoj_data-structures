...
private:
    ...
    std::map<std::string, WebPageSet> term_sets; // map with search terms and WebPageSets (no duplicates)
    std::map<std::string, WebPage*> filenames_; // webpage objects searchable by their page/filename
};
